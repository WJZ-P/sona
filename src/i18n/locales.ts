export const zhCN = {
  ...
  'beautify.assets.folderDescription': '打开 Sona 的资源目录，头像放 avatars，壁纸放 wallpapers。',
  'beautify.assets.inputTitle': '录入资源',
  'beautify.assets.inputDescription': '输入文件名或相对路径，Sona 会按当前功能自动补全 avatars 或 wallpapers。',
...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'beautify.assets.folderDescription': 'Open the Sona asset folder. Put avatars in avatars and wallpapers in wallpapers.',
  'beautify.assets.inputTitle': 'Add Asset',
  'beautify.assets.inputDescription': 'Enter a file name or relative path. Sona will prepend avatars or wallpapers for the current section.',

export const zhCN = {
  ...
  'beautify.avatar.inputDescription': '输入 assets 内的图片资源路径。自定义头像仅支持图片。',
  ...
  'beautify.assets.instructions': '请输入 assets 目录下的图片或视频相对路径，例如 wallpaper.png 或 backgrounds/wallpaper.mp4。',
...
export const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'beautify.avatar.inputDescription': 'Enter an image path inside assets. Custom avatars support images only.',
  ...
  'beautify.assets.instructions': 'Enter an image or video path relative to the assets folder, e.g. wallpaper.png or backgrounds/wallpaper.mp4.',
